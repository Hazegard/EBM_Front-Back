...
INSERT INTO PARAGRAPHES (CONTENT, POSITION, ARTICLE_ID) VALUES ('lol !', 2, 3);
INSERT INTO PARAGRAPHES (CONTENT, POSITION, ARTICLE_ID) VALUES ('test !', 3, 3);
INSERT INTO PARAGRAPHES (CONTENT, POSITION, ARTICLE_ID) VALUES ('42 !', 4, 3);
INSERT INTO PARAGRAPHES (CONTENT, POSITION, ARTICLE_ID) VALUES ('lavi !', 5, 3);
INSERT INTO PARAGRAPHES (CONTENT, POSITION, ARTICLE_ID) VALUES ('lamor !', 6, 3);
...
FROM PARAGRAPHES, (SELECT @rownum := 0) temp
WHERE ARTICLE_ID = 3 ORDER BY POSITION;

SELECT * FROM PARAGRAPHES WHERE ARTICLE_ID =3 ORDER BY POSITION;